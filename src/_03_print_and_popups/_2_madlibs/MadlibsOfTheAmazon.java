...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String adjective = JOptionPane.showInputDialog("Chose a adjective");
		// Get the player to enter a type of liquid
		String liquid = JOptionPane.showInputDialog("Chose a type of liquid");
		// Get the player to enter a body part
		String bodypart = JOptionPane.showInputDialog("Chose a body part");
		// Get the player to enter a verb
		String verb = JOptionPane.showInputDialog("Chose a verb");
		// Get the player to enter a place
		String place = JOptionPane.showInputDialog("Chose a place");
		...
		JOptionPane.showInputDialog(story);
